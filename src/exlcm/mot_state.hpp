...
#ifndef __exlcm_mot_state_hpp__
#define __exlcm_mot_state_hpp__
...
int mot_state::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int mot_state::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int mot_state::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t mot_state::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* mot_state::getTypeName()
{
    return "mot_state";
}

int mot_state::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int mot_state::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int mot_state::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t mot_state::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x8afab3dd98db18feLL;
